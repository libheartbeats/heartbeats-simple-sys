...
pub type heartbeat_acc_pow_window_complete = Option<extern "C" fn(*const heartbeat_acc_pow_context)>;
...
extern "C" {
    ...
    pub fn heartbeat_acc_pow_init(hb: *mut heartbeat_acc_pow_context,
                                  ...
                                  log_fd: c_int,
                                  hwc_callback: heartbeat_acc_pow_window_complete) -> c_int;
    ...
    pub fn hb_acc_pow_get_log_fd(hb: *const heartbeat_acc_pow_context) -> c_int;
