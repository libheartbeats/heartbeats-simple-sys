...
impl HeartbeatPow {
    ...
    pub fn new(window_size: usize,
               hwc_callback: Option<heartbeat_pow_window_complete>) -> Result<HeartbeatPow, &'static str> {
        ...
        unsafe {
            ...
            match heartbeat_pow_init(&mut hb, hbr.capacity() as u64, hbr.as_mut_ptr(), hwc_callback) {
                0 => Ok(HeartbeatPow { hb: hb, hbr: hbr, }),
...
mod test {
    ...
    fn test_simple() {
        ...
        let mut hb = HeartbeatPow::new(5, None).unwrap();
